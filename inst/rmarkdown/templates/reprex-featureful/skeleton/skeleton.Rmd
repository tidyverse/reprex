...
Since `style` is `TRUE`, this difficult-to-read code will be restyled according to the Tidyverse style guide when it's rendered. Whitespace rationing is not in effect!
...
```{python, python.reticulate = requireNamespace("reticulate", quietly = TRUE)}

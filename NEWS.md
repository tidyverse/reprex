...
* There is a new `venue = "jira"` to produce reprex using [JIRA markup](https://jira.atlassian.com/secure/WikiRendererHelpAction.jspa?section=advanced). This new feature requires pandoc 2.7.3 or later, as it takes advantage of the new jira output format for pandoc conversion (#288, @romainfrancois, @cderv) 

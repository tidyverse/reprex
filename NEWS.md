...
* Python: if the reprex appears to use the [reticulate package](https://rstudio.github.io/reticulate/), the session info included via `si = TRUE` also reveals Python session info (#246).

...
<img src="https://raw.githubusercontent.com/tidyverse/reprex/datapasta-gifs/img/datapasta_w_reprex_sheet_to_tribble.gif" alt="Gif of using datapasta::tribble_paste() to get data from a spreadsheet as R code for use in a reprex" style="width: 100%;max-height: 100%" />
...
<div class="figure" style="height: auto">
<img src="https://raw.githubusercontent.com/tidyverse/reprex/datapasta-gifs/img/dpasta_datapasta_reprex.gif" alt="Gif of using datapasta::dpasta() to convert an R data frame into the R code needed to define it in a reprex" style="width: 100%;max-height: 100%" />

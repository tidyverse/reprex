...
## delete anything leftover from a previous aborted render
...
knitr::include_graphics("https://raw.githubusercontent.com/tidyverse/reprex/master/img/README-viewer-screenshot.png")
```
...
```{r include = FALSE}
reprex({y <- 1:4; mean(y)}, comment = "#;-)", show = FALSE, outfile = "README-tmp")
```

leads to this:

```{r child = "README-tmp_reprex.md"}
```

# Contributing to reprex

This outlines how to propose a change to reprex. For more detailed info
...
Conduct](https://reprex.tidyverse.org/dev/CODE_OF_CONDUCT.md). By

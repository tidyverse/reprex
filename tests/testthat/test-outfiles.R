...
test_that("expected outfiles are written and messaged, venue = 'gh'", {
  ...
  msgs <- capture_messages(ret <- reprex(1:5, outfile = "foo", show = FALSE))
...
test_that("expected outfiles are written and messaged, venue = 'R'", {
  ...
  msgs <- capture_messages(ret <- reprex(1:5, outfile = "foo",
                                         show = FALSE, venue = "R"))
  expect_identical(msgs, c(
    "Preparing reprex as .R file to render:\n  * foo_reprex.R\n",
    "Writing reprex markdown:\n  * foo_reprex.md\n",
...
test_that("outfiles in a subdirectory works", {
  ...
  dir.create("foo")
  msgs <- capture_messages(ret <- reprex(1:5, outfile = "foo/foo", show = FALSE))
  expect_identical(msgs, c(
    "Preparing reprex as .R file to render:\n  * foo/foo_reprex.R\n",
    "Writing reprex markdown:\n  * foo/foo_reprex.md\n",
    "Rendered reprex ready on the clipboard.\n"
